...
function addCartClicked (event) {
    ...
    let title = shopProducts.getElementsByClassName('product__title')[0].innerHTML;
    let price = shopProducts.getElementsByClassName('product__price')[0].innerHTML;
...
function addProductToCart(title, price, productImg) {
    ...
    cartShopBox.getElementsByClassName('cart__quantity')[0]
